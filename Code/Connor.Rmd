...
```{r}
# Just want building type, year, median source EUI, number of buildings
data2016 = data2016 %>% select(Year,Building.Type,Median.Source.EUI,Number.of.Buildings)
```
